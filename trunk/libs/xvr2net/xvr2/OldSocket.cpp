...
namespace xvr2{
	namespace Net{
		...
		const int OldSocket::getSocketID(){
			return tsock;
		}

		int OldSocket::setSockOption(int opname, void *optval, 
						unsigned int siz){
#ifdef UNIX_SOCKETS
#ifdef SOLARIS
				char *optval1;
		...
		int OldSocket::setTCPOption(int opname, void *optval, 
						unsigned int siz){
#ifdef UNIX_SOCKETS
		...
		int OldSocket::setSoTimeout(int t){
#ifdef UNIX_SOCKETS
