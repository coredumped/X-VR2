/*
 * $Id:DBOldDriver.cpp 531 2007-08-11 09:05:29Z mindstorm2600 $
 */
#include"config.h"
...
#if __GNUC__ < 3
			setClassName(xvr2::__xvr2_DB_Driver);
#endif
			__is_loaded = false;
...
#ifdef USE_DEBUG
			debugConsole << "  loading driver symbols...\n";
#endif
...
#ifdef USE_DEBUG
				debugConsole << "  WARNING: driver is not bulk load capable\n";
#endif
			}
...
#ifdef USE_DEBUG
			debugConsole << "  initializing driver...";
#endif
			__drv_init(this);
#ifdef USE_DEBUG
			debugConsole << "done\ndriver loaded\n";
...
#ifdef USE_DEBUG
				debugConsole << __FILE__ << ":" << __LINE__ << "  WARNING: driver is not bulk load capable\n";
#endif
				return false;
			}
			try{
