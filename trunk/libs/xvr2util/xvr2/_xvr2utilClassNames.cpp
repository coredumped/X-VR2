...
namespace xvr2 {
	namespace Util {
		...
		const char *__xvr2_Util_Array = "xvr2::Util::Array";
		const char *__xvr2_Util_ConfigFile = "xvr2::Util::ConfigFile";
		const char *__xvr2_Util_Container = "xvr2::Util::Container";
