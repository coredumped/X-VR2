	...
	namespace DB {
		...
		class Connection:public Object{
			...
			public:
				...
				~Connection();
				Connection();
				/** This routine will connect you to the specified @b server
				 *  using the username @b u, password @b p and port
				 *  @b port.
				...
				void disconnect();
				/** This method will send the command @b cmd to the
				 ...
				 *  instead call the @b status method of the ResultSet
