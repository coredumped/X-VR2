...
#DEBUG=
OPTIMIZE=
CFLAGS=-Wall \$(DEBUG) \$(OPTIMIZE) -I../../common -I. -c $DEFINES -Wimplicit -Wreturn-type -Wunused -Wswitch -Wcomment -Wparentheses -Wpointer-arith -Wmissing-prototypes $SDLCFLAGS" >> Makefile
if [ $THREADMODE = 'SDL_THREADS' ]; then
