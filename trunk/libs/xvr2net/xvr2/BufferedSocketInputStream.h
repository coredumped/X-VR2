 ...
 */
#ifndef __XVR2_NET_BUFFERED_SOCKET_INPUT_STREAM_H__
#define __XVR2_NET_BUFFERED_SOCKET_INPUT_STREAM_H__
#include<xvr2/Net/RawSocketInputStream.h>

namespace xvr2 {
	namespace Net {

		class BufferedSocketInputStream : public RawSocketInputStream {
			protected:
				UInt32 _bufsize;
				String buffer;
				String _lterm;
